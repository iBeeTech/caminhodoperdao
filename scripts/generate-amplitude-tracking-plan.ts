...
function createRow(data: Record<string, string>): string {
  const columns = [
    "Action",
    "Object Type",
    "Object Name",
...
// ============ GERAÇÃO DO CSV ============
function generateAmplitudeImportCSV(): string {
  const rows: CSVRow[] = [];
  ...
  const headerRow = {
    ...
    "Event Hidden From Dropdowns": "Event Hidden From Dropdowns",
    "Event Hidden From Persona Results": "Event Hidden From Persona Results",
    "Event Hidden From Pathfinder": "Event Hidden From Pathfinder",
    "Event Hidden From Timeline": "Event Hidden From Timeline",
    "Event Source": "Event Source",
    "Property Type": "Property Type",
    "Property Group Names": "Property Group Names",
    ...
    "Property Is Array": "Property Is Array",
    "Enum Values": "Enum Values",
    "Property Regex": "Property Regex",
    "Const Value": "Const Value",
    "String Property Value Min Length": "String Property Value Min Length",
    "String Property Value Max Length": "String Property Value Max Length",
    "Number Property Value Min": "Number Property Value Min",
    "Number Property Value Max": "Number Property Value Max",
    "Array Min Items": "Array Min Items",
    "Array Max Items": "Array Max Items",
  };
  rows.push(headerRow);

  // Property Group genérico para todas as propriedades
  const propertyGroupRow: CSVRow = {
  ...
  for (const [_key, eventName] of Object.entries(AMPLITUDE_EVENTS)) {
    const schema =
      EVENT_PROPERTIES_SCHEMA[
        eventName as keyof typeof EVENT_PROPERTIES_SCHEMA
      ];
