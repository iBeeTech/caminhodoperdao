...
import { formatPhoneBR } from "../../../../src/utils/formatters/phone";
...
describe("formatPhoneBR", () => {
  ...
  it("deve formatar 10 dígitos corretamente (sem 9)", () => {
    expect(formatPhoneBR("1133334444")).toBe("(11) 33334-444");
  });

  it("deve remover caracteres não numéricos", () => {
    expect(formatPhoneBR("(11) 9999-9999")).toBe("(11) 99999-999");
  });
